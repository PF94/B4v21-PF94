...
if(!$ORBS::Hooks::GuiTransfer)
   exec("Add-Ons/System_oRBs/hooks/guiTransfer.cs");

//Set old indication var
$ORBS::ORBSR_GUITransfer_Hook = 1;

echo("\c2WARNING: ORBSR_GUITransfer_Hook.cs has moved. Please alter to use hooks/guiTransfer.cs");